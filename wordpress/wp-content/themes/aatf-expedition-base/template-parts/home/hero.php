...
<!-- ── Search Bar ────────────────────────────────────────────────── -->
<div class="bg-white -mt-7 shadow-[0_8px_40px_rgba(0,0,0,0.13)] mx-auto max-w-7xl rounded-lg relative z-20 flex items-center divide-x divide-gray-200 overflow-hidden border border-gray-100">
    ...
    <!-- Search Button -->
    <button class="bg-gray-800 rounded-xl hover:bg-gray-900 text-white font-bold px-4 py-3 mr-3 flex items-center gap-1.5 transition-colors text-xs tracking-wide uppercase whitespace-nowrap">
