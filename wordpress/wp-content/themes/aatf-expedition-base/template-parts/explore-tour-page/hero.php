...
<section class="hero-bg relative min-h-[680px] flex flex-col items-center justify-center text-center"
    ...
    <div class="relative z-10 px-6 py-20 w-full">
        <h1 class="font-display text-5xl md:text-6xl font-bold text-white mb-4 drop-shadow-lg tracking-wide">
            <?php echo esc_html($hero_title); ?>
        </h1>
        <p class="text-white/90 text-lg md:text-xl font-light tracking-[0.2em] drop-shadow mb-12">
        ...
        <!-- ── Hero Search Bar (simplified AJAX) ────────────────────── -->
